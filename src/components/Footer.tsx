...
const Footer = () => {
  return (
    <div className="bg-black w-full sm:pt-56 pt-36 text-white relative">
      <div className=" pb-[20rem] flex flex-row max-w-[750px]">
        <div className="sm:pl-40 lg:pl-10 xl:pl-20 pl-6 -mt-40">
          <div className="sm:-mt-[170px] -mt-[50px]">
            <h2 className="text-Blue_Primary font-bold sm:pl-2 pl-1">Sobre Nós</h2>
      ...
      <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
        <FaInstagram size={30} className="text-gray-500 hover:text-Blue_Primary " />
      </a>
      <a href="https://wa.me/yourphonenumber" target="_blank" rel="noopener noreferrer">
        <FaWhatsapp size={30} className="text-gray-500 hover:text-Blue_Primary " />
      </a>
      <a href="mailto:youremail@example.com" target="_blank" rel="noopener noreferrer">
        <FaEnvelope size={30} className="text-gray-500 hover:text-Blue_Primary " />
      </a>
    </div>
        </div>
          <div className="">
          <Image alt="" src={FooterImage} className="absolute -top-72 xl:-top-60 lg:-top-48 right-0 sm:w-[500px] lg:w-[600px] xl:w-[700px] 2xl:w-[1000px] "/>
   </div>
      </div>
